...
const infinitySpeakerData = [
    { name: 'Mr. Sai Prasad Vishwanathan', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/saiprasad.jpg',
    ...
    { name: 'Ms. Jhanvi Narang', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/jhanvinarang.jpg',
    ...
    { name: 'Maj Gen Chandrashekar Mani', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/mani.jpg',
    ...
    { name: 'Mr. Rahul Singh', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/rahul.jpg',
    ...
    { name: 'Mr. Sai Satish', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/satish.jpg',
    ...
    { name: 'Mrs. Lavanya Patnala', image: 'https://tedxhitam.com/assets/pasteditions/tedx2023/lavanya.jpg',
...
const rrSpeakerData = [
    { name: 'Dr. Chandrashekar', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/chandrashekar.jpg',
    ...
    { name: 'Dr. Rajdeep Manwani', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/rajdeepmanwani.jpg',
    ...
    { name: 'Mr. Uday Krishna Peddireddi', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/udaykrishna.jpg',
    ...
    { name: 'Mr. Vinay Singh', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/vinaysingh.jpg',
    ...
    { name: 'Ms. Prachi Shevgaonkar', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/prachi.jpg',
    ...
    { name: 'Ms. Vidya Sivalenka', image: 'https://tedxhitam.com/assets/pasteditions/tedx2024/vidyashivlenka.jpg',
        ...
        <motion.section variants={itemVariants}>
            ...
            <div className="theme-grid">
                <motion.div className="theme-image" variants={itemVariants}>
                    ...
                    <img src={'https://tedxhitam.com/assets/pasteditions/tedx2023/infinity_logo.png'} alt="TEDx HITAM Infinity Logo" className="rounded-lg infinity-logo" />
                </motion.div>
                <div className="theme-description">
                    <p>The TEDx HITAM theme, "Infinity: Beyond Innovation," challenges us to move beyond simply improving what already exists. It's a call to transcend conventional boundaries and explore the uncharted territories of imagination and creativity.</p>
                    <p>This theme embraces "Infinity" as a symbol of limitless potential. It's a quest to unveil visionary ideas, foster mindsets that embrace the unknown, and inspire the kind of positive, transformative change that redefines our future.</p>
                </div>
            </div>
        </motion.section>
        <motion.section>
        ...
        <motion.section variants={itemVariants}>
            ...
            <div className="theme-grid">
                <motion.div className="theme-image" variants={itemVariants}>
                    ...
                    <img src={'https://tedxhitam.com/assets/pasteditions/tedx2024/RandR_logo.png'} alt="TEDx HITAM Ripple & Resonate Logo" className="rounded-lg randr-logo" />
                </motion.div>
                <div className="theme-description">
